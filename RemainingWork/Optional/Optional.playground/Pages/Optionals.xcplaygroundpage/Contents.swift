...
// 여러 개의 옵셔널 바인딩과 불리언 조건을 함께 사용 가능  , 로 구분
...
// 값이 있을때는 ?? 앞에 값이 들어가고 없으면 ?? 뒤에 값이 들어간다
...
let anotherExpression = optionalStr ?? "This is a nil value"  // 값이 있을때는 ?? 앞에 값이 들어가고 없으면 ?? 뒤에 값이 들어간다
print(optionalStr)
...
var optionalArr1: [Int]? = [1,2,3] // Optinal<Array<Int>>
var optionalArr2: [Int?] = [1,2,3] // Array<Optional<Int>>
