...
let filteringNumbers = numbers.filter { $0 >= 0 }
...
let reduceNestedArr = nestedArr.reduce([]) { $0 + $1}
reduceNestedArr
...
let question1 = array.map { $0.compactMap { $0 } }
question1
print(question1)

let question2 = array.flatMap { $0 }
print(question2)

let question3 = array.flatMap { $0.compactMap { $0 } }
print(question3)
