...
case ...32 :
    print("It's very cold. Consider wearing a scarf.")
case 86...:
    print("It's really warm. Don't forget ti wear suncreem.")
default:
    print("It's not that cold. Wear a t-shirt.")
}
...
switch somePoint {
case (let distance, 0), (0, let distance): //y또는 x 값이 0 일때 들어가는 조건
...
switch someInt {
case let somevalue where somevalue%2 == 0:
    print("This is even")
case let somevalue where somevalue%2 != 0:
...
case 2, 3, 5, 7, 11, 13, 17, 19:
  ...
  fallthrough //조건이 맞아서 들어오면 다음 코드도 실행 되게 하는코드 break 반대 개념
default:
...
//func update(age: Int) {
//  if 1...100 ~= age { // 범위 ~=  범위안에 값이 포함 되면 true
//    print("Update")
//  }
//}
...
func someFunction() {
  ...
  // gaurd문의 조건을 만족할 때만 다음으로 넘어갈 것
    let tr : Bool = Bool.random()
    print("변수 tr \(tr)")
  guard tr else { return } // guard 조건이 true 이면 else를 실행하지 않고 false 이면 else를 실행한다
    print("가드문 \(tr)")
  // ...
  // ...
}
