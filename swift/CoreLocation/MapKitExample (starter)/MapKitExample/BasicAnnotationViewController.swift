...
final class BasicAnnotationViewController: UIViewController {
  ...
  override func viewDidAppear(_ animated: Bool) {
    ...
    let center = CLLocationCoordinate2DMake(37.566300, 126.9777948)
  ...
  @IBAction private func setupCamera(_ sender: Any) {
    ...
    camera.centerCoordinate = CLLocationCoordinate2DMake(37.566300, 126.9777948)
    // 고도 (미터 단위)
    camera.altitude = 200
    
    // 카메라 각도 (0 일때 수직으로 내려다보는 형태
    camera.pitch = 30.0
    heading += 10.0
